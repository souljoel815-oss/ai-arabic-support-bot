...
public class MissingAttachmentRuleTests
{
    ...
    public void Silent_When_No_Deductible_Lines()
    {
        ...
        new MissingAttachmentRule()
            .Evaluate(ctx)
            .Should()
            .BeEmpty(because: "no deductible lines means FR-016 doesn't apply");
    }
    ...
    private static Supplier NewRegisteredSupplier() =>
        new(
            ...
            taxProfile: SupplierTaxProfile.RegisteredTaxpayer(EgyptianTin.Parse("123456789"), VatId)
        );
}
