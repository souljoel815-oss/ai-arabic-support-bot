...
public class SupplierPaymentVoucherTests
{
    ...
    public void CreateDraft_StartsInDraft_WithGrossEqualToNet_AndZeroWht()
    {
        ...
        v.WhtPayableAmount.Amount.Should().Be(0m,
            because: "Phase 9 default — WHT is zero until US7's WhtComputeService applies a split");
        v.NetCashPaid.Amount.Should().Be(10_000m,
            because: "with no WHT, cash leg equals gross");
    ...
    {
        var v = SupplierPaymentVoucher.CreateDraft(Guid.NewGuid(),
        ...
        v.Allocations.Should().HaveCount(1,
            because: "the rejection MUST happen before the second allocation lands");
    }
    ...
    public void MarkPosted_RequiresAtLeastOneAllocation()
    {
        ...
        var act = () => v.MarkPosted("PAY-001", Guid.NewGuid(),
    ...
    public void MarkPosted_TransitionsToPosted_OnSuccess()
    {
        ...
        v.MarkPosted("PAY-001", Guid.NewGuid(),
            new DateTime(2026, 5, 9, 10, 0, 0, DateTimeKind.Utc));
    ...
    public void ApplyWhtSplit_ReducesNetCashPaid_AndStampsCertificateId()
    {
        ...
        v.NetCashPaid.Amount.Should().Be(9_500m,
            because: "10k gross − 500 WHT = 9,500 cash leg");
