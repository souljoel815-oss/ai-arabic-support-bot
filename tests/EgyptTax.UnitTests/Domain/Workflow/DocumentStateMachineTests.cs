...
public class DocumentStateMachineTests
{
    ...
    public void ApprovalEnabled_TransitionsAllowed(
        DocumentState from,
        DocumentState to,
        bool expected
    )
    {
        DocumentStateMachine.CanTransition(from, to, approvalEnabled: true).Should().Be(expected);
    }
    ...
    {
        DocumentStateMachine.CanTransition(from, to, approvalEnabled: true).Should().BeFalse();
    }
    ...
    public void Posted_IsTerminal_RegardlessOfApprovalConfig()
    {
        ...
        {
            DocumentStateMachine
                .CanTransition(DocumentState.Posted, target, approvalEnabled: true)
                .Should()
                .BeFalse();
            DocumentStateMachine
                .CanTransition(DocumentState.Posted, target, approvalEnabled: false)
                .Should()
                .BeFalse();
        }
    }
    ...
    public void Voided_IsTerminal_RegardlessOfApprovalConfig()
    {
        ...
        {
            DocumentStateMachine
                .CanTransition(DocumentState.Voided, target, approvalEnabled: true)
                .Should()
                .BeFalse();
            DocumentStateMachine
                .CanTransition(DocumentState.Voided, target, approvalEnabled: false)
                .Should()
                .BeFalse();
        }
    }
    ...
    public void Transition_OnRejection_ThrowsInvalidOperationException()
    {
        ...
        act.Should().Throw<InvalidOperationException>().WithMessage("*Posted*Voided*");
    }
