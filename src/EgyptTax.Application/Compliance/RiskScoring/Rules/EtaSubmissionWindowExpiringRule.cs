    ...
    public IReadOnlyList<RiskFinding> Evaluate(DocumentRiskContext context)
    {
        ...
        if (remaining <= TimeSpan.Zero)
        {
            return [new RiskFinding(
                ...
                new ArabicEnglishText("انتهت نافذة الإرسال", "ETA submission window has expired"),
        ...
        if (remaining <= TimeSpan.FromHours(6))
        {
            return [new RiskFinding(
                ...
                new ArabicEnglishText("نافذة الإرسال على وشك الانتهاء", "ETA submission window closes very soon"),
                new ArabicEnglishText(
        ...
        if (remaining <= TimeSpan.FromHours(24))
        {
            return [new RiskFinding(
                ...
                new ArabicEnglishText("نافذة الإرسال خلال 24 ساعة", "ETA submission window closes within 24h"),
                new ArabicEnglishText(
