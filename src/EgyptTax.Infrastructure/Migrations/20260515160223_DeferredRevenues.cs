...
{
    /// <inheritdoc />
    public partial class DeferredRevenues : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "deferred_revenues",
                schema: "accounting",
                columns: table => new
                {
                    ...
                    revenue_account_code = table.Column<string>(type: "varchar(16)", unicode: false, maxLength: 16, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_deferred_revenues", x => x.id);
                });
        }
