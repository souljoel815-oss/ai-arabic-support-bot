...
namespace EgyptTax.Infrastructure.Migrations
{
    ...
    public partial class TaxPeriods : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    period_kind = table.Column<string>(
                        type: "nvarchar(32)",
                        maxLength: 32,
                        nullable: false
                    ),
                    ...
                    locked_reason = table.Column<string>(
                        type: "nvarchar(500)",
                        maxLength: 500,
                        nullable: true
                    ),
                    reopened_at_utc = table.Column<DateTime>(type: "datetime2(3)", nullable: true),
                    reopened_by_user_id = table.Column<Guid>(
                        type: "uniqueidentifier",
                        nullable: true
                    ),
                    reopened_reason = table.Column<string>(
                        type: "nvarchar(500)",
                        maxLength: 500,
                        nullable: true
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "tax_periods", schema: "workflow");
        }
    }
}
