...
namespace EgyptTax.Infrastructure.Migrations
{
    ...
    public partial class ApprovalRequests : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    submitted_by_user_id = table.Column<Guid>(
                    ...
                    approved_by_user_id = table.Column<Guid>(
                        type: "uniqueidentifier",
                        nullable: true
                    ),
                    approved_at_utc = table.Column<DateTime>(type: "datetime2(3)", nullable: true),
                    rejected_by_user_id = table.Column<Guid>(
                        type: "uniqueidentifier",
                        nullable: true
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "approval_requests", schema: "workflow");
        }
    }
}
