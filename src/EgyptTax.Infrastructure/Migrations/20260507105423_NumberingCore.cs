...
namespace EgyptTax.Infrastructure.Migrations
{
    ...
    public partial class NumberingCore : Migration
    {
        ...
        {
            migrationBuilder.EnsureSchema(name: "numbering");
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.PrimaryKey(
                        "PK_document_number_allocator",
                        x => new { x.series_id, x.fiscal_year }
                    );
                    table.ForeignKey(
...
"
        ...
        {
            migrationBuilder.DropTable(name: "document_number_allocator", schema: "numbering");

            migrationBuilder.DropTable(name: "document_series", schema: "numbering");
        }
    }
}
