        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    payment_reference = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    ...
                    customer_wht_certificate_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    gross_receipt_amount = table.Column<decimal>(type: "decimal(19,2)", nullable: false),
                    net_cash_received = table.Column<decimal>(type: "decimal(19,2)", nullable: false),
                    wht_receivable_amount = table.Column<decimal>(type: "decimal(19,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    posted_at_utc = table.Column<DateTime>(type: "datetime2(3)", nullable: true),
                    posted_by_user_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    generated_wht_certificate_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    gross_payment_amount = table.Column<decimal>(type: "decimal(19,2)", nullable: false),
                    net_cash_paid = table.Column<decimal>(type: "decimal(19,2)", nullable: false),
                    wht_payable_amount = table.Column<decimal>(type: "decimal(19,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    supplier_payment_voucher_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    customer_receipt_voucher_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    target_document_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    target_document_type = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
