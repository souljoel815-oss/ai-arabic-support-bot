        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    filename_original = table.Column<string>(type: "nvarchar(260)", maxLength: 260, nullable: false),
                    filename_storage = table.Column<string>(type: "varchar(260)", unicode: false, maxLength: 260, nullable: false),
                    relative_path = table.Column<string>(type: "varchar(512)", unicode: false, maxLength: 512, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    supplier_invoice_number = table.Column<string>(type: "varchar(64)", unicode: false, maxLength: 64, nullable: false),
                    ...
                    supplier_tax_profile_snapshot_default_purchase_vat_category_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    supplier_tax_profile_snapshot_type = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    supplier_tax_profile_snapshot_reverse_charge = table.Column<bool>(type: "bit", nullable: false),
                    supplier_tax_profile_snapshot_tin = table.Column<string>(type: "varchar(9)", unicode: false, maxLength: 9, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    expense_category_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_purchase_invoice_lines_item_xor_expense", "([item_id] IS NOT NULL AND [expense_category_id] IS NULL) OR ([item_id] IS NULL AND [expense_category_id] IS NOT NULL)");
                    table.ForeignKey(
