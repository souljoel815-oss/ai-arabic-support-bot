        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    pdf_path = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    structured_json_path = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    line_count = table.Column<int>(type: "int", nullable: false),
                    total_wht_payable = table.Column<decimal>(type: "decimal(19,2)", nullable: false)
                },
                constraints: table =>
                {
