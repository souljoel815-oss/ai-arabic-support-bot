        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    source_voucher_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    source_invoice_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    wht_category_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    rate_applied_percent = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    certificate_number = table.Column<string>(type: "varchar(64)", unicode: false, maxLength: 64, nullable: false),
