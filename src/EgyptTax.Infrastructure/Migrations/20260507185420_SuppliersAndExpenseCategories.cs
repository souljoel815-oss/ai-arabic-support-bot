...
namespace EgyptTax.Infrastructure.Migrations
{
    ...
    public partial class SuppliersAndExpenseCategories : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    default_account_id = table.Column<Guid>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    last_tin_revalidated_at_utc = table.Column<DateTime>(
                        type: "datetime2(3)",
                        nullable: true
                    ),
                    ...
                    tax_profile_default_purchase_vat_category_id = table.Column<Guid>(
                        type: "uniqueidentifier",
                        nullable: true
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "deductible_expense_categories", schema: "master");

            migrationBuilder.DropTable(name: "suppliers", schema: "master");
        }
    }
}
