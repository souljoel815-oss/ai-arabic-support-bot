...
namespace EgyptTax.Infrastructure.Migrations
{
    ...
    public partial class EtaSubmissionsDashboard : Migration
    {
        ...
        {
            migrationBuilder.EnsureSchema(name: "eta");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    submission_uuid = table.Column<string>(
                        type: "varchar(64)",
                        unicode: false,
                        maxLength: 64,
                        nullable: true
                    ),
                    last_attempt_at_utc = table.Column<DateTime>(
                        type: "datetime2(3)",
                        nullable: true
                    ),
                    ...
                    submission_window_expires_at_utc = table.Column<DateTime>(
                        type: "datetime2(3)",
                        nullable: false
                    ),
            ...
            migrationBuilder
                ...
                .Annotation(
                    "SqlServer:Include",
                    new[] { "sales_invoice_id", "attempt_count", "error_code" }
                );
        ...
        {
            migrationBuilder.DropTable(name: "eta_submissions", schema: "eta");
        }
    }
}
