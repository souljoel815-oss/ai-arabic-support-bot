...
namespace EgyptTax.Infrastructure.Migrations
{
    ...
    public partial class FixedAssets : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    asset_category = table.Column<string>(
                        type: "nvarchar(32)",
                        maxLength: 32,
                        nullable: false
                    ),
                    ...
                    depreciation_method = table.Column<string>(
                        type: "nvarchar(32)",
                        maxLength: 32,
                        nullable: false
                    ),
                    convention = table.Column<string>(
                        type: "nvarchar(16)",
                        maxLength: 16,
                        nullable: false
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "fixed_assets", schema: "documents");
        }
    }
}
