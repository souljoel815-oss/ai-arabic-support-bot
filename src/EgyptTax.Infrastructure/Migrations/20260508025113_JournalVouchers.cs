        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    source_document_type = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
                    ...
                    reverses_journal_voucher_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    created_by_user_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    created_at_utc = table.Column<DateTime>(type: "datetime2(3)", nullable: false),
                    narration_ar = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    narration_en = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    journal_voucher_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
