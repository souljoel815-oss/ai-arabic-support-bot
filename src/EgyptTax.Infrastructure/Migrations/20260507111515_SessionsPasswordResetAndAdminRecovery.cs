...
namespace EgyptTax.Infrastructure.Migrations
{
    ...
    public partial class SessionsPasswordResetAndAdminRecovery : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    target_email = table.Column<string>(
                        type: "varchar(254)",
                        unicode: false,
                        maxLength: 254,
                        nullable: false
                    ),
                    recovered_at_utc = table.Column<DateTime>(
                        type: "datetime2(3)",
                        nullable: false
                    ),
                    machine_name = table.Column<string>(
                        type: "nvarchar(256)",
                        maxLength: 256,
                        nullable: false
                    ),
                    operator_identity = table.Column<string>(
                        type: "nvarchar(256)",
                        maxLength: 256,
                        nullable: true
                    ),
                    audit_emitted_at_utc = table.Column<DateTime>(
                        type: "datetime2(3)",
                        nullable: true
                    ),
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    issued_by_admin_user_id = table.Column<Guid>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    user_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    issued_at_utc = table.Column<DateTime>(type: "datetime2(3)", nullable: false),
                    last_activity_at_utc = table.Column<DateTime>(
                        type: "datetime2(3)",
                        nullable: false
                    ),
                    absolute_expires_at_utc = table.Column<DateTime>(
                        type: "datetime2(3)",
                        nullable: false
                    ),
                    revoked_at_utc = table.Column<DateTime>(type: "datetime2(3)", nullable: true),
                    revocation_reason = table.Column<string>(
                        type: "nvarchar(40)",
                        maxLength: 40,
                        nullable: true
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "admin_recovery_log", schema: "identity");
