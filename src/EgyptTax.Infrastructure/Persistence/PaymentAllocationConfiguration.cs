...
internal sealed class PaymentAllocationConfiguration : IEntityTypeConfiguration<PaymentAllocation>
{
    public void Configure(EntityTypeBuilder<PaymentAllocation> b)
    {
        ...
        b.Property(a => a.TargetDocumentType).HasColumnName("target_document_type")
            .HasConversion<string>().HasMaxLength(32).IsRequired();

        b.ComplexProperty(a => a.AllocatedAmount,
            p => p.Property(x => x.Amount).HasColumnName("allocated_amount").HasColumnType("decimal(19,2)").IsRequired());
        ...
        b.HasIndex(a => a.TargetDocumentId).HasDatabaseName("ix_payment_allocations_target_document_id");
    }
}
