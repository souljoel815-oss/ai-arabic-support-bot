...
internal sealed class WhtCategoryConfiguration : IEntityTypeConfiguration<WhtCategory>
{
    public void Configure(EntityTypeBuilder<WhtCategory> b)
    {
        ...
        b.Property(c => c.RatePercent).HasColumnName("rate_percent").HasColumnType("decimal(5,2)").IsRequired();
        b.Property(c => c.EffectiveFromDate).HasColumnName("effective_from_date").HasColumnType("date").IsRequired();
        b.Property(c => c.EffectiveToDate).HasColumnName("effective_to_date").HasColumnType("date");
        b.Property(c => c.ApplicableTo).HasColumnName("applicable_to")
