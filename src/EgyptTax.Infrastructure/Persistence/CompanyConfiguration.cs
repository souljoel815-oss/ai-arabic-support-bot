...
internal sealed class CompanyConfiguration : IEntityTypeConfiguration<Company>
{
    public void Configure(EntityTypeBuilder<Company> b)
    {
        ...
        b.Property(c => c.TaxRegistrationNumber)
            .HasColumnName("tax_registration_number")
            .HasMaxLength(9)
            .IsUnicode(false)
            .IsRequired();
        b.Property(c => c.CommercialRegistrationNumber)
        ...
        b.Property(c => c.FiscalYearStartMonth)
            .HasColumnName("fiscal_year_start_month")
            .IsRequired();
        b.Property(c => c.DefaultCurrency)
            .HasColumnName("default_currency")
            .HasMaxLength(3)
            .IsUnicode(false)
            .IsRequired();
        b.Property(c => c.DefaultLanguage)
            .HasColumnName("default_language")
            .HasConversion<string>()
            .HasMaxLength(2)
            .IsRequired();
        b.Property(c => c.TaxpayerActivityCode)
