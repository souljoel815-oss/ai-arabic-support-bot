...
internal sealed class AttachmentConfiguration : IEntityTypeConfiguration<Attachment>
{
    public void Configure(EntityTypeBuilder<Attachment> b)
    {
        ...
        b.Property(a => a.FilenameOriginal).HasColumnName("filename_original").HasMaxLength(260).IsRequired();
        b.Property(a => a.FilenameStorage).HasColumnName("filename_storage").HasMaxLength(260).IsUnicode(false).IsRequired();
        b.Property(a => a.RelativePath).HasColumnName("relative_path").HasMaxLength(512).IsUnicode(false).IsRequired();
        b.Property(a => a.Sha256).HasColumnName("sha256").HasColumnType("binary(32)").IsRequired();
        b.Property(a => a.MimeType).HasColumnName("mime_type").HasMaxLength(100).IsUnicode(false).IsRequired();
        ...
        b.Property(a => a.UploadedAtUtc).HasColumnName("uploaded_at_utc").HasColumnType("datetime2(3)").IsRequired();
