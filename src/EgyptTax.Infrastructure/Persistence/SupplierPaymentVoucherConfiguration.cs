...
internal sealed class SupplierPaymentVoucherConfiguration : IEntityTypeConfiguration<SupplierPaymentVoucher>
{
    public void Configure(EntityTypeBuilder<SupplierPaymentVoucher> b)
    {
        ...
        b.Property(v => v.PaymentDate).HasColumnName("payment_date").HasColumnType("date").IsRequired();
        ...
        b.ComplexProperty(v => v.GrossPaymentAmount,
            p => p.Property(x => x.Amount).HasColumnName("gross_payment_amount").HasColumnType("decimal(19,2)").IsRequired());
        b.ComplexProperty(v => v.WhtPayableAmount,
            p => p.Property(x => x.Amount).HasColumnName("wht_payable_amount").HasColumnType("decimal(19,2)").IsRequired());
        b.ComplexProperty(v => v.NetCashPaid,
            p => p.Property(x => x.Amount).HasColumnName("net_cash_paid").HasColumnType("decimal(19,2)").IsRequired());
