...
internal sealed class AdminRecoveryRecordConfiguration : IEntityTypeConfiguration<AdminRecoveryRecord>
{
    public void Configure(EntityTypeBuilder<AdminRecoveryRecord> b)
    {
        ...
        b.Property(r => r.TargetEmail).HasColumnName("target_email").HasMaxLength(254).IsUnicode(false).IsRequired();
        b.Property(r => r.RecoveredAtUtc).HasColumnName("recovered_at_utc").HasColumnType("datetime2(3)").IsRequired();
        ...
        b.Property(r => r.AuditEmittedAtUtc).HasColumnName("audit_emitted_at_utc").HasColumnType("datetime2(3)");
