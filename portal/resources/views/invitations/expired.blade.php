...
@section('content')
    <div class="max-w-md mx-auto">
        <div class="card-padded text-center shadow-elevation-3 animate-fade-in-up">
            ...
            <p class="eyebrow mb-2 !text-red-700">دعوة منتهية</p>
            <h1 class="display-2 mb-3">{{ __('organisation.expired_title') }}</h1>
            <p class="text-ink-600 leading-relaxed mb-7">{{ __('organisation.expired_body') }}</p>
